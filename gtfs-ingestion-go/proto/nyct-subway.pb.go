...
const file_nyct_subway_proto_rawDesc = "" +
	"\n" +
	"\x11nyct-subway.proto\x12\x10transit_realtime\x1a\x13gtfs-realtime.proto\"~\n" +
	...
	"\x15nyct_stop_time_update\x12+.transit_realtime.TripUpdate.StopTimeUpdate\x18\xe9\a \x01(\v2$.transit_realtime.NyctStopTimeUpdateR\x12nyctStopTimeUpdateB`\n" +
	"\x1bcom.google.transit.realtimeZAgithub.com/jmccormick7/MTARealtimePipeline/gtfs-ingestor-go/proto"

var (
	file_nyct_subway_proto_rawDescOnce sync.Once
	file_nyct_subway_proto_rawDescData []byte
)

func file_nyct_subway_proto_rawDescGZIP() []byte {
	file_nyct_subway_proto_rawDescOnce.Do(func() {
		file_nyct_subway_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_nyct_subway_proto_rawDesc), len(file_nyct_subway_proto_rawDesc)))
	})
...
var file_nyct_subway_proto_goTypes = []any{
...
func file_nyct_subway_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_nyct_subway_proto_rawDesc), len(file_nyct_subway_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 3,
			NumServices:   0,
